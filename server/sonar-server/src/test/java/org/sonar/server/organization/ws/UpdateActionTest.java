...
public class UpdateActionTest {
  ...
  public void request_fails_if_name_is_one_char_long_when_uuid_is_provided() {
    ...
    executeUuidRequest(SOME_UUID, "a");
  }
  ...
  public void request_succeeds_if_name_is_two_chars_long_when_uuid_is_provided() {
    ...
    verifyResponseAndDb(executeUuidRequest(SOME_UUID, "ab"), dto, "ab", SOME_DATE);
  }
  ...
  public void request_fails_if_name_is_65_chars_long_when_uuid_is_provided() {
    ...
    executeUuidRequest(SOME_UUID, STRING_65_CHARS_LONG);
  }
  ...
  public void request_succeeds_if_name_is_64_char_long_when_uuid_is_provided() {
    ...
    verifyResponseAndDb(executeUuidRequest(SOME_UUID, name), dto, name, SOME_DATE);
  }
  ...
  public void request_succeeds_if_description_url_and_avatar_are_not_specified_when_uuid_is_specified() {
    ...
    Organizations.UpdateWsResponse response = executeUuidRequest(SOME_UUID, "bar", null, null, null);
  ...
  public void request_succeeds_if_description_url_and_avatar_are_specified_when_uuid_is_specified() {
    ...
    Organizations.UpdateWsResponse response = executeUuidRequest(SOME_UUID, "bar", "moo", "doo", "boo");
  ...
  public void request_fails_if_description_is_257_chars_long_when_uuid_is_specified() {
    ...
    executeUuidRequest(SOME_UUID, "bar", STRING_257_CHARS_LONG, null, null);
  }
  ...
  public void request_succeeds_if_description_is_256_chars_long_when_uuid_is_specified() {
    ...
    Organizations.UpdateWsResponse response = executeUuidRequest(SOME_UUID, "bar", description, null, null);
  ...
  public void request_fails_if_url_is_257_chars_long_when_uuid_is_specified() {
    ...
    executeUuidRequest(SOME_UUID, "bar", null, STRING_257_CHARS_LONG, null);
  }
  ...
  public void request_succeeds_if_url_is_256_chars_long_when_uuid_is_specified() {
    ...
    Organizations.UpdateWsResponse response = executeUuidRequest(SOME_UUID, "bar", null, url, null);
  ...
  public void request_fails_if_avatar_is_257_chars_long_when_uuid_is_specified() {
    ...
    executeUuidRequest(SOME_UUID, "bar", null, null, STRING_257_CHARS_LONG);
  }
  ...
  public void request_succeeds_if_avatar_is_256_chars_long_when_uuid_is_specified() {
    ...
    Organizations.UpdateWsResponse response = executeUuidRequest(SOME_UUID, "bar", null, null, avatar);
  ...
  private Organizations.UpdateWsResponse executeUuidRequest(String uuid, @Nullable String name) {
  ...
  private Organizations.UpdateWsResponse executeUuidRequest(String uuid, @Nullable String name,
    ...
    return executeRequest(uuid, null, name, description, url, avatar);
  }
  ...
  private Organizations.UpdateWsResponse executeRequest(@Nullable String uuid, @Nullable String key,
  ...
  private void verifyResponseAndDb(Organizations.UpdateWsResponse response,
    ...
    assertThat(organization.getUuid()).isEqualTo(dto.getUuid());
